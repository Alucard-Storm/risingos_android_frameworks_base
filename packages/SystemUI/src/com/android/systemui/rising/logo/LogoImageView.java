...
public class LogoImageView extends ImageView {
    ...
    private void updateLogoVisibility() {
    	if (rightLogo != null) {
    	    rightLogo.setVisibility(mShowLogo ? (mLogoPosition == 1 ? View.VISIBLE : View.GONE) : View.GONE);
    	} 
    	if (leftLogo != null) {
            leftLogo.setVisibility(mShowLogo ? (mLogoPosition == 0 ? View.VISIBLE : View.GONE) : View.GONE);
        }
    }
